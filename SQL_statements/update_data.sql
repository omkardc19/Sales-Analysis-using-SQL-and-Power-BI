...
---------- The script updates the date columns in database with recent dates and it inserts new dates in the date dimension. 

---------- It uses the current year as the last year for the data in the database. 
